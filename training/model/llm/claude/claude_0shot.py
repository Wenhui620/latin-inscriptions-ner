...
def ner_bio_tagging(text):
    system_prompt = """You are a Latin epigraphy Named Entity Recognition (NER) expert. 
    Your task is to assign BIO tags to each token of Latin funerary inscriptions.
...
if __name__ == "__main__":
    ...
    tags_output = os.path.join(base_dir, "training/model/llm/claude/0shot.json")
